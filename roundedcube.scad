...
module roundedcubez(size = [1, 1, 1], center = false, radius = 0.5, apply_to = "all") {
	intersection() {
		roundedcube(size, center, radius, apply_to="z");
		scale([1.0, 1.0, 1.1])
			cube(size, center);
	}
}

// The good stuff!!!!  Forget about the whack stuff above.
// centered on XY only
